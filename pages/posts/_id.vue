  ...
  <main class="">
    ...
    <section class="max-w-4xl mx-auto px-3">
      ...
      <article class="w-full mx-auto my-6">
          <nuxt-content class="prose max-w-none mx-auto prose-code:text-base-content text-base-content prose-headings:text-base-content prose-strong:text-base-content prose-img:rounded-md prose-a:text-accent" :document="post" />
      </article>
    </section>
  </main>
</template>
